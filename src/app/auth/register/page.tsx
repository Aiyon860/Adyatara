      ...
      >
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-[13px] text-gray-300 font-light leading-relaxed">
            Bergabunglah dengan komunitas penjelajah budaya Indonesia. Kisahmu menunggumu.
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-[55%] flex flex-col justify-center px-8 md:px-24 py-12 relative">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[13px] text-gray-400 font-light">Mulai petualanganmu hari ini</p>
          </div>
