...
import { BookOpen, Play, ArrowRight, Wallpaper, ScrollText } from "lucide-react";

const features = [
  {
    title: "Naratif Interaktif",
    description: "Pilihan ada di tanganmu. Setiap keputusan membawa alur berbeda — akankah kamu menjadi pahlawan atau legenda baru?",
    icon: BookOpen,
  },
  {
    title: "Visual Nusantara",
    description: "Nikmati estetika budaya yang dikemas dengan visual modern, membawa keajaiban dongeng leluhur ke layar perangkatmu.",
    icon: Wallpaper,
  },
  {
    title: "Warisan Hidup",
    description: "Pelajari nilai moral, sejarah, dan fakta unik di balik setiap legenda sambil bermain dan mengumpulkan poin pengetahuan.",
    icon: ScrollText,
  }
]
...
const stories = [
  { 
    ...
    image: "/images/sumatera-barat.jpg",
    gradient: "linear-gradient(to bottom, rgba(13,10,8,0.1) 0%, rgba(13,10,8,0.3) 40%, rgba(13,10,8,0.95) 100%)"
  },
  { 
    tag: "TRAGEDI", 
    prov: "TANAH SUNDA", 
    ...
    image: "/images/jawa-barat.jpg",
    gradient: "linear-gradient(to bottom, rgba(13,10,8,0.1) 0%, rgba(13,10,8,0.4) 40%, rgba(13,10,8,0.95) 100%)"
  },
  { 
    tag: "MISTERI", 
    prov: "JANTUNG JAWA", 
    ...
    gradient: "linear-gradient(to bottom, rgba(13,10,8,0.1) 0%, rgba(13,10,8,0.5) 40%, rgba(13,10,8,0.95) 100%)"
  },
]
  ...
  return (
    <div className="min-h-screen bg-[#0A0705] text-[#F5F0EB]">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(to bottom, rgba(10, 7, 5, 0.3) 0%, rgba(10, 7, 5, 0.7) 30%, rgba(10, 7, 5, 1) 100%), url('/images/hero-background.jpg')",
        }}
      >
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 relative py-8">
            <div className="text-center flex flex-col items-center justify-center">
              ...
              <p className="text-[9px] tracking-[0.3em] text-gray-500 uppercase">Provinsi</p>
            </div>
            <div className="text-center flex flex-col items-center justify-center">
              <div className="text-4xl md:text-5xl font-serif text-[#D96B4A] mb-3">
                12+
              </div>
              <p className="text-[9px] tracking-[0.3em] text-gray-500 uppercase">Cerita</p>
            </div>
            <div className="text-center flex flex-col items-center justify-center">
              <div className="text-4xl md:text-5xl font-serif text-[#D96B4A] mb-3">
                3
              </div>
              <p className="text-[9px] tracking-[0.3em] text-gray-500 uppercase">Ending</p>
            </div>
            <div className="text-center flex flex-col items-center justify-center">
              <div className="text-4xl md:text-5xl font-serif text-[#D96B4A] mb-3">
                ∞
              </div>
              <p className="text-[9px] tracking-[0.3em] text-gray-500 uppercase">Pilihan</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-[9px] tracking-[0.3em] text-[#D96B4A] uppercase font-medium">ADYATARA</p>
              <div className="h-px w-12 bg-[#D96B4A]/30"></div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-[9px] tracking-[0.3em] text-[#D96B4A] uppercase font-medium">CERITA PILIHAN</p>
              <div className="h-px w-16 bg-gray-800"></div>
            </div>
            ...
            <p className="text-center text-[13px] text-gray-400 max-w-md leading-relaxed font-light">
              Setiap provinsi menyimpan mitologi yang hidup. Temukan kebijaksanaan leluhur melalui narasi yang kamu bentuk sendiri.
            </p>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-[#0A0705] relative overflow-hidden flex items-center min-h-[500px]"
        style={{
          backgroundImage: "linear-gradient(to right, rgba(10, 7, 5, 1) 0%, rgba(10, 7, 5, 0.95) 40%, rgba(10, 7, 5, 0.6) 100%), url('/images/cta-background.png')",
      ...
      >
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="max-w-md">
            <p className="text-[9px] tracking-[0.3em] text-[#D96B4A] uppercase font-medium mb-3">WARISAN BUDAYA</p>
            <h2 className="text-4xl md:text-[2.75rem] font-serif text-white mb-6 leading-[1.1]">
              Setiap Pilihan<br />Menulis Sejarah
            </h2>
            <p className="text-[13px] text-gray-300 mb-10 leading-relaxed font-light">
              Dalam ADYATARA, tidak ada jalan yang salah. Hanya jalur yang berbeda. Ikuti alur asli folklor atau bentuk timeline alternatifmu sendiri.
            </p>
            <Link
              href="/auth/register"
